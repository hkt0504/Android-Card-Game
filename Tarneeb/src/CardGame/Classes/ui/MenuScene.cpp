...
bool MenuScene::init()
{
	...
	auto quitItem = MenuItemImage::create("Buttons/btn_back.png", "Buttons/btn_back.png", CC_CALLBACK_1(MenuScene::menuCloseCallback, this));
	quitItem->setPosition(origin.x + visibleSize.width - quitItem->getContentSize().width / 2 - 50, origin.y + visibleSize.height - quitItem->getContentSize().height / 2 - 50);
	auto menuQuit = Menu::create(quitItem, NULL);
	menuQuit->setPosition(Vec2::ZERO);
	this->addChild(menuQuit, 10);

	auto playItem = MenuItemImage::create("Buttons/guest_btn.png", "Buttons/guest_btn.png", CC_CALLBACK_1(MenuScene::menuPlayCallback, this));
	...
	auto helpItem = MenuItemImage::create("Buttons/btn_howtoplay.png", "Buttons/btn_howtoplay.png", CC_CALLBACK_1(MenuScene::menuHelpCallback, this));
	...
	auto facebookItem = MenuItemImage::create("Buttons/facebook_btn.png", "Buttons/facebook_btn.png", CC_CALLBACK_1(MenuScene::menuFaceBookCallback, this));
	...
	auto moreItem = MenuItemImage::create("Buttons/more_game_sidestrip.png", "Buttons/more_game_sidestrip.png", CC_CALLBACK_1(MenuScene::menuMoreCallback, this));
	...
	auto rateItem = MenuItemImage::create("Buttons/rate_game_rightstrip.png", "Buttons/rate_game_rightstrip.png", CC_CALLBACK_1(MenuScene::menuRateCallback, this));
	...
	soundItem->setPosition(origin.x + soundItem->getContentSize().width / 2 + 50, origin.y + visibleSize.height - soundItem->getContentSize().height / 2 - 50);
...
void MenuScene::createParticleAction()
{
	...
	if (particleIndex < MAX_PARTICLE_SIZE) {
		int rand1 = rand();
		Vec2 startPos;
		...
		//CCLog("Call createHeartAction (%d), (%f,%f), %f, %f, %f", particleIndex, startPos.x, startPos.y, startDelayTime, totalDistance, scale);
		this->addChild(spr);
...
{
	AppService::menuScene = NULL;
	Scene *pScene = TransitionFade::create(0.5, ModeScene::createScene(GAME_FROM_GUEST));
