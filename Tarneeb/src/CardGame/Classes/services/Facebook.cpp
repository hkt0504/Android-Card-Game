...
const char* FBConnectClassName = "com/al3aabna/tarneeb/fb/FacebookConnect";
const char* FBFriendClassName = "com/al3aabna/tarneeb/fb/FacebookFriend";
const char* FBPostClassName = "com/al3aabna/tarneeb/fb/FacebookPost";
const char* FBSendRequestsClassName = "com/al3aabna/tarneeb/fb/FacebookRequests";
const char* FBScoreClassName = "com/al3aabna/tarneeb/fb/FacebookScore";
const char* GameClassName = "com/al3aabna/tarneeb/entry/Game";
...
extern "C"
{
void Java_com_al3aabna_tarneeb_fb_FacebookConnect_nativeCallback(JNIEnv* env, jobject thiz, jint action, jobject params)
{
	Facebook::menuScene->onFaceBook(action);
}

void Java_com_al3aabna_tarneeb_fb_FacebookScore_nativeCallback(JNIEnv* env, jobject thiz, jobject games)
{
