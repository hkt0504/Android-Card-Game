...
const char* FBConnectClassName = "com/spade/spadegame/fb/FacebookConnect";
const char* FBFriendClassName = "com/spade/spadegame/fb/FacebookFriend";
const char* FBPostClassName = "com/spade/spadegame/fb/FacebookPost";
const char* FBSendRequestsClassName = "com/spade/spadegame/fb/FacebookRequests";
const char* FBScoreClassName = "com/spade/spadegame/fb/FacebookScore";
const char* GameClassName = "com/spade/spadegame/entry/Game";
...
extern "C"
{
void Java_com_spade_spadegame_fb_FacebookConnect_nativeCallback(JNIEnv* env, jobject thiz, jint action, jobject params)
{
	Facebook::menuScene->onFaceBook(action);
}

void Java_com_spade_spadegame_fb_FacebookScore_nativeCallback(JNIEnv* env, jobject thiz, jobject games)
{
