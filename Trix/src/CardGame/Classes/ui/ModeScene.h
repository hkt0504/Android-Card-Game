...
public:
    ...
    void menuKSingleCallback(cocos2d::Ref* pSender);
    void menuKPartnerCallback(cocos2d::Ref* pSender);
    void menuCSingleCallback(cocos2d::Ref* pSender);
    void menuCPartnerCallback(cocos2d::Ref* pSender);
