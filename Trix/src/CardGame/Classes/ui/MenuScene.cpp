...
bool MenuScene::init()
{
	...
	auto spriteLogo = Sprite::create("logo1.png");
	spriteLogo->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height / 2 + 90));
	...
	quitItem->setPosition(Vec2(origin.x + visibleSize.width - quitItem->getContentSize().width / 2 - BACK_BTN_MARGIN,
			origin.y + visibleSize.height - quitItem->getContentSize().height / 2 - BACK_BTN_MARGIN));
