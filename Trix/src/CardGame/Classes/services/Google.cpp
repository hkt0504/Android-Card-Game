...
const char* GoogleClassName = "com/al3aabna/trix/inapp/GoogleBilling";

extern "C"
{
	void Java_com_al3aabna_trix_inapp_GoogleBilling_nativeCallback(JNIEnv*  env, jobject thiz, jint action)
	{
